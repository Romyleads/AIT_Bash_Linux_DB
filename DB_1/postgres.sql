...
CREATE USER maria WITH PASSWORD 'secure123'; -- создаём пользователя

CREATE DATABASE college_db OWNER maria; -- создаём базу данных

-- подключаемся к базе college_db
...
TRUNCATE TABLE students RESTART IDENTITY; -- очищаем таблицу и сбрасываем счётчик id
...
TRUNCATE TABLE students RESTART IDENTITY; -- снова очищаем таблицу и сбрасываем id
